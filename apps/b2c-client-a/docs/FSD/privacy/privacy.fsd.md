...
> B2C Client 템플릿 A · `/privacy` · id `privacy`
...
| 기능 | 사용자 동작 | 시스템 처리 | 결과 |
|---|---|---|---|
| 개인정보 처리방침 조회 기능 제공 | 개인정보 처리방침 조회 | 등록된 데이터를 조회한다 | 조회한 정보를 화면에 표시한다 |
...
- 개인정보 처리방침 조회 → 결과가 화면에 바로 반영된다.

### 인수 조건

- **Given** 이 화면을 열었을 때 **When** 개인정보 처리방침 조회 **Then** 그 결과가 화면에 반영된다.
