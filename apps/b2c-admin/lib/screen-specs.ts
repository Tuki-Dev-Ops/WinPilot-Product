...
export const SCREEN_SPECS: ScreenSpec[] = [
  ...
  {
    screen: 'support',
    purpose: '이 콘솔에서 직접 바꿀 수 없는 것을 스페이스플래닝에 묻습니다.',
  ...
  {
    screen: 'components',
    purpose: '쓰고 있는 컴포넌트를 실제로 그려 봅니다.',
    actions: [
      '컴포넌트 훑어보기',
    ],
    guards: [
