 ...
 *
 * 화면 하나하나의 IA 는 `/docs/ia/{화면}` 으로 나갔다. 한 장에 43개 화면을 다 그리면 도면이
 * 화면보다 커져서, "이 등록 화면은 어디서 들어가나" 하나를 보려는 사람이 도면 전체를 훑어야 한다.
 *
    ...
    <div className="flex min-w-0 flex-col gap-6 lg:flex-row lg:items-start lg:gap-8">
      ...
      <div className="flex min-w-0 flex-1 flex-col gap-6">
        <DocHeader
          trail={['문서', '개요', '전체']}
          title="IA — 정보 구조"
          description="사이드바가 곧 구조다. 도면은 메뉴 정의(lib/navigation/admin-menu.ts)에서 만들어지므로 메뉴를 고치면 도면이 따라온다. 화면 하나의 IA 는 왼쪽 목록에서 고른다."
        />
        ...
        <section className="flex min-w-0 flex-col gap-3">
          ...
          <Mermaid code={siteMap()} title="어드민 사이드바" />
        </section>
