...
/**
 * Feature: `franchise.faq.create` · F&B Admin · route `/franchise/faqs/new`
 *
 * 갈래(`창업`)를 화면이 정해서 넘긴다 — 여기서 만든 글이 다른 목록에 서면 안 된다.
 * 공개를 꺼 둔 채로 열린다(`blankFnbFaq`).
 */
export const metadata: Metadata = {
  title: adminTitle('창업', 'FAQ', '새 글'),
...
export default function FnbFaqCreatePage() {
  return (
    ...
    >
      <FaqForm faq={blankFnbFaq('창업')} mode="create" />
    </FnbShell>
  );
}
