...
export const IA_GROUPS: IaGroup[] = [
  ...
  },
  {
    ...
    screens: [
      ...
      { screen: 'menus-categories', ko: '메뉴 묶음' },
    ...
    notes: [
      ...
      '메뉴 묶음은 목록 안이 아니라 옆 화면이다 — 묶음은 값이 아니라 규칙이라, 목록에 섞으면 찾지 못한다.',
  ...
  },
  {
    ...
    notes: [
      ...
      '창구 번호가 둘이다. 하나로 두면 창업 전화가 매장 번호로 가고, 그 전화를 받는 사람은 답할 수 없는 것을 묻는 사람과 통화한다.',
