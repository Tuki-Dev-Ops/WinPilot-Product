...
/**
 * Feature: `status.result` · IR Admin · route `/result`
 *
 * 세 앱 중 마지막 하나. 컴포넌트도 문구 구조도 앞의 둘과 같고, 돌아갈 곳만 사내 어드민의
 * 화면을 가리킨다.
 */
export const metadata: Metadata = { title: "처리 결과 — WinPilot IR Admin" };
...
export default async function IrStatusResultPage({
  searchParams,
}: {
  ...
  return (
    <IrShell sectionId="result" trail={['처리 결과']}>
      <StatusScreen
