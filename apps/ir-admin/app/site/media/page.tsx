...
/**
 * Feature: `site.media` · IR Admin · route `/site/media`
 *
...
export const metadata: Metadata = {
  title: '홈페이지 | 미디어 — Spaceplanning IR Admin',
  robots: { index: false, follow: false },
};

export default function IrSiteMediaPage() {
  return (
    <IrShell sectionId="site" trail={['홈페이지', '미디어']} activeChildId="site-media">
      <MediaListView />
    </IrShell>
  );
}
