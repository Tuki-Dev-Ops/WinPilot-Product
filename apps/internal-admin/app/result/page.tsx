...
const KIND = {
  save: { done: '저장했습니다.', failed: '저장하지 못했습니다.', back: { href: '/tenants', label: '고객사 목록' } },
  invoice: {
    done: '청구서를 발행했습니다.',
...
export default async function InternalStatusResultPage({ searchParams }: { searchParams: Promise<Search> }) {
    ...
    <StatusScreen
      ...
      description={
        failed
          ...
          : ['변경 내용이 반영되었습니다.', '고객사 화면에는 설정에 따라 적용됩니다.']
      }
