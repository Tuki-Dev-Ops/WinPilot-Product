...
/**
 * Feature: `payment.settings` · Internal Admin · route `/integrations/payment`
 * 이름은 `@winpilot/spec` 의 features.ts 가 강제한다 (pnpm spec:check).
 *
 * 이 화면도 B2C Admin 에서 옮겨 왔다 — 실결제 전환은 되돌리기 어려워 사내에서만 다룬다.
 */
export const metadata: Metadata = {
  title: '연동 | PG 정보 — WinPilot Internal',
...
export default async function InternalPaymentSettingsPage({
  ...
  return (
    <InternalShell sectionId="integration" trail={['연동', 'PG 정보']} activeChildId="integration-payment">
