...
export const IA_GROUPS: IaGroup[] = [
  ...
  },
  {
    ...
    edges: [],
    data: ['@winpilot/store · IR_COMPANY (IR 문의처 · 개인정보보호책임자)'],
    notes: [
      ...
      '문의 경로는 원문 확정 전에도 제공한다. 약관은 IR 문의처, 처리방침은 개인정보 보호책임자가 담당한다.',
      '두 화면에만 제목 상단에 메인 페이지 이동 링크를 배치한다. 상단 내비게이션에 포함되지 않는 화면이기 때문이다.',
