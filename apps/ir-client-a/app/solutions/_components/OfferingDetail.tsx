 ...
 *
 * ## 어드민 연동
 * - 제품 넷 ← `@winpilot/store` 의 `SOLUTIONS` (IR 어드민 제품 · 솔루션)
 * - 서비스 둘 ← 같은 곳의 `SERVICE_DETAILS`
 */
    ...
    <div className="flex flex-col gap-14">
      ...
      */}
      <section className="flex flex-col gap-4">
        ...
        <p className="max-w-3xl text-lg leading-relaxed lg:text-xl">{offering.problem}</p>
        <p className="max-w-3xl text-sm leading-loose text-ink-muted lg:text-base">{offering.approach}</p>
      </section>
