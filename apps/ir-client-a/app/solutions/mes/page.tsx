...
/**
 * Feature: `solution.detail` · IR Client (템플릿 A) · route `/solutions/mes`
 *
 ...
 */
export const metadata: Metadata = { title: `Cloud MES — ${IR_COMPANY.name}` };

export default function SolutionMesPage() {
  const solution = findSolution('mes');
